...
public class Rocket1Overlay extends Ris3ModElements.ModElement {
	public Rocket1Overlay(Ris3ModElements instance) {
		super(instance, 33);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (CheckRocket1Procedure.executeProcedure(ImmutableMap.of("world", world))) {
				...
				Minecraft.getInstance().ingameGUI.blit(posX + -214, posY + 49, 0, 0, 16, 16, 16, 16);
				...
				Minecraft.getInstance().ingameGUI.blit(posX + -214, posY + 42, 0, 0, 16, 16, 16, 16);
				RenderSystem.depthMask(true);
				RenderSystem.enableDepthTest();
				RenderSystem.enableAlphaTest();
				RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
