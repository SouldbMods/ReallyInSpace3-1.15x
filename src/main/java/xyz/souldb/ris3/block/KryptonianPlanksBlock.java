...
public class KryptonianPlanksBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:kryptonian_planks")
	public static final Block block = null;
	public KryptonianPlanksBlock(Ris3ModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("kryptonian_planks");
		}
