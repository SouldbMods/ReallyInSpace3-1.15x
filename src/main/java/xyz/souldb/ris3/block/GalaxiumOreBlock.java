...
import xyz.souldb.ris3.item.GalaxiumDustItem;
...
public class GalaxiumOreBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:galaxium_ore")
	public static final Block block = null;
	public GalaxiumOreBlock(Ris3ModElements instance) {
		super(instance, 45);
	}
