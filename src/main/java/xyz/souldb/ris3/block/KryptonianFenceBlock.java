...
public class KryptonianFenceBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:kryptonian_fence")
	public static final Block block = null;
	public KryptonianFenceBlock(Ris3ModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("kryptonian_fence");
		}
