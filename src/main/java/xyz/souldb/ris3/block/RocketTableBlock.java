...
import xyz.souldb.ris3.procedures.FixRkTableProcedure;
...
public class RocketTableBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:rocket_table")
	public static final Block block = null;
	public RocketTableBlock(Ris3ModElements instance) {
		super(instance, 109);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				FixRkTableProcedure.executeProcedure($_dependencies);
			}
