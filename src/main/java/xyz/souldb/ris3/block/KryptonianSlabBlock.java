...
public class KryptonianSlabBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:kryptonian_slab")
	public static final Block block = null;
	public KryptonianSlabBlock(Ris3ModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("kryptonian_slab");
		}
