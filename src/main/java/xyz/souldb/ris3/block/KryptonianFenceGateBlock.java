...
public class KryptonianFenceGateBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:kryptonian_fence_gate")
	public static final Block block = null;
	public KryptonianFenceGateBlock(Ris3ModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("kryptonian_fence_gate");
		}
